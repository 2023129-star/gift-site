...
Роскошь, просто р-о-с-к-о-ш-ь, что ты есть у меня! ♡`,
  ...
  {
    name: "От Аюши",
    letter: `Эргим ынак эживис Саглашкавыс,
торуттунген хунун таварыштыр — сенээ чугле экини кузээр-дыр мен 🤍

Кызымак эшкам, дыка-дыка бедик чедиишкиннерни черле чедип аар деп бузурээр-дыр мен 🫂

Спасибо тебе за нашу дружбуууу,
